...
<div class="container-fluid">
	...
	<div class="m-2">
		...
		<h2><i class="fas fa-list"></i> アプリデータ一覧 <span class="mx-2 px-1 text-white" style="background-color:#FF8F22"><?= $item_num ?></span></h2>
	...
	$( document ).ready( function() {
		...
		$( '#uploadform' ).submit( function( e ) {
            ...
            $.ajax({
				...
				$( '#response_panel' ).removeClass( 'alert-success' ).addClass( 'alert-danger' );
				$( '#response_panel' ).html( '<i class="fas fa-times"></i> エラー: ipaファイルのアップロードに失敗しました。' );
				$( '#upload_btn_text' ).text( "アップロード" );
				$( '#upload_btn_icon' ).removeClass( "fa-spinner fa-spin" ).addClass( "fa-upload" );
				$( '#upload_btn' ).prop( 'disabled', false );
			}).always( function() {
